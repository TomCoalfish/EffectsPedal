...
override PKGDIR = xconfig_EffectsPedal
...
package/%.xdc.inc package/%_xconfig_EffectsPedal.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_EffectsPedal" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: EffectsPedal.p28FP

-include package/cfg/EffectsPedal_p28FP.mak
-include package/cfg/EffectsPedal_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/EffectsPedal_p28FP.dep
endif
EffectsPedal.p28FP: package/cfg/EffectsPedal_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
EffectsPedal.p28FP package/cfg/EffectsPedal_p28FP.c: .libraries,28FP
endif

package/cfg/EffectsPedal_p28FP.c package/cfg/EffectsPedal_p28FP.h package/cfg/EffectsPedal_p28FP.xdl: override _PROG_NAME := EffectsPedal.x28FP
package/cfg/EffectsPedal_p28FP.c: package/cfg/EffectsPedal_p28FP.cfg
package/cfg/EffectsPedal_p28FP.xdc.inc: package/cfg/EffectsPedal_p28FP.xdl
package/cfg/EffectsPedal_p28FP.xdl package/cfg/EffectsPedal_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/EffectsPedal_p28FP.cfg
	-$(RM) package/cfg/EffectsPedal_p28FP.dep
	-$(RM) package/cfg/EffectsPedal_p28FP.c
	-$(RM) package/cfg/EffectsPedal_p28FP.xdc.inc

clean,28FP::
	-$(RM) EffectsPedal.p28FP
.executables,28FP .executables: EffectsPedal.x28FP

EffectsPedal.x28FP: |EffectsPedal.p28FP

-include package/cfg/EffectsPedal.x28FP.mak
EffectsPedal.x28FP: package/cfg/EffectsPedal_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 -z  -o $@ package/cfg/EffectsPedal_p28FP.o28FP   package/cfg/EffectsPedal_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
EffectsPedal.x28FP: export C_DIR=
EffectsPedal.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
EffectsPedal.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

EffectsPedal.test test,28FP test: EffectsPedal.x28FP.test

EffectsPedal.x28FP.test:: EffectsPedal.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 EffectsPedal.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.EffectsPedal.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,EffectsPedal.x28FP,*)


clean:: clean,28FP

clean,28FP::
	-$(RM) EffectsPedal.x28FP
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
EffectsPedal_p28FP.o28FP,copy : package/cfg/EffectsPedal_p28FP.o28FP
EffectsPedal_p28FP.s28FP,copy : package/cfg/EffectsPedal_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_EffectsPedal
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_EffectsPedal.tar.dep
endif
package/rel/xconfig_EffectsPedal/xconfig_EffectsPedal/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_EffectsPedal/xconfig_EffectsPedal/package/package.rel.xml: package/build.cfg
package/rel/xconfig_EffectsPedal/xconfig_EffectsPedal/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_EffectsPedal/xconfig_EffectsPedal/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_EffectsPedal.tar: package/rel/xconfig_EffectsPedal.xdc.inc package/rel/xconfig_EffectsPedal/xconfig_EffectsPedal/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_EffectsPedal.xdc.inc,package/rel/xconfig_EffectsPedal.tar.dep)


release release,xconfig_EffectsPedal: all xconfig_EffectsPedal.tar
clean:: .clean
	-$(RM) xconfig_EffectsPedal.tar
	-$(RM) package/rel/xconfig_EffectsPedal.xdc.inc
	-$(RM) package/rel/xconfig_EffectsPedal.tar.dep
