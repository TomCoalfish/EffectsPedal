...
override PKGDIR = xconfig_LabProject
...
package/%.xdc.inc package/%_xconfig_LabProject.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_LabProject" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: LabProject.p28FP

-include package/cfg/LabProject_p28FP.mak
-include package/cfg/LabProject_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/LabProject_p28FP.dep
endif
LabProject.p28FP: package/cfg/LabProject_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
LabProject.p28FP package/cfg/LabProject_p28FP.c: .libraries,28FP
endif

package/cfg/LabProject_p28FP.c package/cfg/LabProject_p28FP.h package/cfg/LabProject_p28FP.xdl: override _PROG_NAME := LabProject.x28FP
package/cfg/LabProject_p28FP.c: package/cfg/LabProject_p28FP.cfg
package/cfg/LabProject_p28FP.xdc.inc: package/cfg/LabProject_p28FP.xdl
package/cfg/LabProject_p28FP.xdl package/cfg/LabProject_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/LabProject_p28FP.cfg
	-$(RM) package/cfg/LabProject_p28FP.dep
	-$(RM) package/cfg/LabProject_p28FP.c
	-$(RM) package/cfg/LabProject_p28FP.xdc.inc

clean,28FP::
	-$(RM) LabProject.p28FP
.executables,28FP .executables: LabProject.x28FP

LabProject.x28FP: |LabProject.p28FP

-include package/cfg/LabProject.x28FP.mak
LabProject.x28FP: package/cfg/LabProject_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 -z  -o $@ package/cfg/LabProject_p28FP.o28FP   package/cfg/LabProject_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
LabProject.x28FP: export C_DIR=
LabProject.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
LabProject.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

LabProject.test test,28FP test: LabProject.x28FP.test

LabProject.x28FP.test:: LabProject.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 LabProject.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.LabProject.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,LabProject.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
LabProject_p28FP.o28FP,copy : package/cfg/LabProject_p28FP.o28FP
LabProject_p28FP.s28FP,copy : package/cfg/LabProject_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_LabProject
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_LabProject.tar.dep
endif
package/rel/xconfig_LabProject/xconfig_LabProject/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_LabProject/xconfig_LabProject/package/package.rel.xml: package/build.cfg
package/rel/xconfig_LabProject/xconfig_LabProject/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_LabProject/xconfig_LabProject/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_LabProject.tar: package/rel/xconfig_LabProject.xdc.inc package/rel/xconfig_LabProject/xconfig_LabProject/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_LabProject.xdc.inc,package/rel/xconfig_LabProject.tar.dep)


release release,xconfig_LabProject: all xconfig_LabProject.tar
clean:: .clean
	-$(RM) xconfig_LabProject.tar
	-$(RM) package/rel/xconfig_LabProject.xdc.inc
	-$(RM) package/rel/xconfig_LabProject.tar.dep
